...
144, 361 the square of 19, 25921 the square of 161, and so on. It gets obvious if we write b's elements in terms
of squares:
a = [121, 144, 19, 161, 19, 144, 19, 11]
...
function comp(array1, array2){
   return array1.map(function(val){
       return val * val;
   }).every(function(val){
...
/*function comp(array1, array2){
   ...
   console.log(array1.map(function(val){
        return val * val;
